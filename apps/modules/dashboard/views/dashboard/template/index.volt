...
<body>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-4 col-md-6 text-center text-md-left">
                                    ...
                                    <div class="header-top-social-links">
                                        ...
                                        <ul class="social-link-small">
                                            <li><a href="//www.facebook.com"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li><a href="//www.twitter.com"><i class="ion-social-twitter"></i></a></li>
                                            <li><a href="//plus.google.com"><i
                                ...
                                <div class="col-lg-4 offset-lg-4 col-md-6">
                                    ...
                                    <div
                                        ...
                                        <div class="header-top-single-dropdown">
                                            <a href="javascript:void(0)" class="active-dropdown-trigger"
                                                id="language-options"> <img src="assets/img/icons/en-gb.png" alt="">
                                            ...
                                            <div
                                                ...
                                                <ul>
                                                    <li><a href="#"> <img src="assets/img/icons/en-gb.png" alt="">
                                                            English </a></li>
                                                    <li><a href="#"> <img src="assets/img/icons/de-de.png" alt="">
                                                            Germany </a></li>
                                                </ul>
                                            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="navigation-top-search-area pt-25 pb-25">
                            <div class="row align-items-center">
                                ...
                                <div
                                    class="col-xl-3 col-lg-3 order-3 order-sm-2 order-lg-3 order-xs-3 col-md-4 col-sm-5 text-center text-sm-left mt-xs-25">
                                ...
                                <div
                                    class="col-6 col-xl-1 col-lg-2 text-right order-2 order-sm-3 order-lg-4 order-xs-2 col-md-2 col-sm-2">
                                    <!--=======  cart icon  =======-->
                                        ...
                                        <div class="small-cart deactive-dropdown-menu">
                                            <div class="small-cart-item-wrapper">
                                                <div class="single-item">
                                                    <div class="image">
                                                        <a href="single-product.html">
                                                            <img src="assets/img/cart-image/small1-90x90.jpg"
                                                                class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                ...
                                                <div class="single-item">
                                                    ...
                                                    <div class="image">
                                                        <a href="single-product.html">
                                                            <img src="assets/img/cart-image/small2-90x90.jpg"
                                                                class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <ul class="mega-menu four-column">
                                            ...
                                            <li class="megamenu-banner d-none d-lg-block mt-30 w-100">
                                                <a href="shop-left-sidebar.html" class="mb-0">
                                                    <img src="assets/img/banners/img-bottom-menu.jpg" class="img-fluid"
                                                        alt="">
                                                </a>
                                            </li>
                                        </ul>
    ...
    {{ partial('dashboard/template/footer') }}
